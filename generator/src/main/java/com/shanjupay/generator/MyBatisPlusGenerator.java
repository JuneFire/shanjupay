...
//				.setUrl("jdbc:mysql://218.29.75.103:6306/shanjupay_merchant_service?serverTimezone=Asia/Shanghai");
		...
		// 交易服务
		dataSourceConfig
				.setUrl("jdbc:mysql://172.23.138.132:3306/shanjupay_transaction?characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai");
...
//        strategyConfig.setRestControllerStyle(true);
        ...
        // 如需要制定单个表, 需填写参数如:
         strategyConfig.setInclude("platform_channel");
